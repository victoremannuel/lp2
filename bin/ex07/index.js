...
function main() {
    ...
    const gerente = new Gerente_1.Gerente("Carlos Silva", "G123", 5000);
    const assistente = new Assistente_1.Assistente("Mariana Souza", "A456", 3000);
    const vendedor = new Vendedor_1.Vendedor("Pedro Lima", "V789", 4000, 1000);
